...
namespace PuntoDeVenta
{
    public partial class FrmBuscarArticulo : Form
    {
        ...
        private void btnLimpiar_Click(object sender, EventArgs e)
        {
            ...
            btnDescripcion.Text = string.Empty;
            btnReferencia.Text = string.Empty;
        ...
        bool ValidarCampos() 
        {
            ...
            if (this.btnCodigo.Text.Trim().Length <= 0)
            {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                btnCodigo.Text = row.Cells["ColumnCodigo"].Value.ToString();
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                DataGridViewRow row = dataGridView1.Rows[e.RowIndex];
                btnCodigo.Text = row.Cells["ColumnCodigo"].Value.ToString();
                btnDescripcion.Text = row.Cells["ColumnDescripcionn"].Value.ToString();
                btnReferencia.Text = row.Cells["ColumnReferencia"].Value.ToString();
